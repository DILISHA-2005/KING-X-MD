      ...
      if (_0x4dbcb0) {
        ...
        if (_0x1e75d9 === "1.1") {
          await _0xaf8db8.sendMessage(_0x5eb615, {
            ...
            'caption': "*© Gᴇɴʀᴇʀᴀᴛᴇᴅ Bʏ 𝙺𝙸𝙽𝙶-𝚇-𝙼𝙳*"
          }, {
            'quoted': _0x2405c0
          });
        } else {
          if (_0x1e75d9 === "1.2") {
            await _0xaf8db8.sendMessage(_0x5eb615, {
              ...
              'caption': "*© Gᴇɴᴇʀᴀᴛᴇᴅ Bʏ 𝙺𝙸𝙽𝙶-𝚇-𝙼𝙳*"
            }, {
              'quoted': _0x2405c0
            });
          } else {
  ...
  try {
    ...
    _0x3dfd8e.ev.on("messages.upsert", async _0x3276da => {
      ...
      if (_0xfacf40) {
        ...
        if (!isNaN(_0x5975fb) && _0x5975fb > 0x0 && _0x5975fb <= _0x66d8c6.length) {
          const _0x51bcf2 = _0x66d8c6[_0x5975fb - 0x1];
          const _0x3c116b = "https://darksadas-yt-cinezsub-search.vercel.app/?query=new&apikey=pramashi01" + encodeURIComponent(_0x51bcf2.link);
          try {
            const _0x306fd2 = await axios.get(_0x3c116b);
            const _0x4bd79a = _0x306fd2.data.result;
            const _0x446048 = _0x4bd79a.dl_links || [];
            ...
            _0x3dfd8e.ev.on('messages.upsert', async _0xbe427f => {
              ...
              if (_0x14cafc) {
                ...
                if (!isNaN(_0x315031) && _0x315031 > 0x0 && _0x315031 <= _0x446048.length) {
                  ...
                  const _0x27bb65 = "https://darksadas-yt-cinezsub-dl.vercel.app/?url=https://cinesubz.co/api-rwjdzuehbdrwjdzuehbdzjyvxo2bhh0azjyvxo2bhh0auehbdruehbdrwjdzuehbdzjyvxo2bhh0azjyvxo2bhh0auehbdrwjdzuehbwjdzuehbdzjyvxo2bhh0azjyvxo2bhh0a/8sfvsciiya/&apikey=pramashi01" + _0x58dd91;
                  await _0x3dfd8e.sendMessage(_0x4a183a, {
                    'react': {
                      'text': '⬆',
                      'key': _0xe26d99.key
